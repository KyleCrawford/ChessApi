...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_UserGame_ToUserTwo]...';


GO
ALTER TABLE [dbo].[UserGame] DROP CONSTRAINT [FK_UserGame_ToUserTwo];


GO
PRINT N'Altering Table [dbo].[UserGame]...';


GO
ALTER TABLE [dbo].[UserGame] ALTER COLUMN [PlayerTwo] NVARCHAR (128) NULL;
...
GO
PRINT N'Refreshing Procedure [dbo].[spCreateGame]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spCreateGame]';
